...
/* harmony default export */ __webpack_exports__["default"] = ({
    mixins: [__WEBPACK_IMPORTED_MODULE_0_laravel_nova__["Filterable"], __WEBPACK_IMPORTED_MODULE_0_laravel_nova__["Paginatable"], __WEBPACK_IMPORTED_MODULE_0_laravel_nova__["PerPageable"]],
    data: function data() {
        return {
            routes: [],
            search: '',
    ...
    methods: {
        getRoutes: function getRoutes() {
            ...
            Nova.request().get('/nova-vendor/route-viewer/routes').then(function (response) {
        ...
        order: function order(event) {
            ...
            this.routes.sort(function (route1, route2) {
                ...
                return comparison * _this2.sortOrder;
            });
        }
    },
    computed: {
        routesAsResources: function routesAsResources() {
            var _this3 = this;

            return this.routes.filter(function (route) {
                var regex = new RegExp('(' + _this3.search + ')', 'i');
          ...
          [
            _c("resource-table", {
              ...
              attrs: {
                ...
                resources: _vm.routesAsResources,
                "singular-name": "route"
              },
              on: { order: _vm.order }
            })
